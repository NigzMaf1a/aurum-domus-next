        ...
        <ul className={styles.list}>
          <div className={styles.sidebarDiv}>
            <li className={styles.listItem}>
              <Link href="/chef/dashboard" id={styles.link}>
          ...
          <div className={styles.sidebarDiv}>
            <li className={styles.listItem}>
              <Link href="/chef/dishes" id={styles.link}>
                <i className="bi bi-egg-fried me-2 fs-5" /> {t("dishes")}
              </Link>
            </li>
          </div>
          ...
          <div className={styles.sidebarDiv}>
            <li className={styles.listItem}>
              <Link href="/chef/orders" id={styles.link}>
          ...
          <div className={styles.sidebarDiv}>
            <li className={styles.listItem}>
              <Link href="/chef/reservations" id={styles.link}>
          ...
          <div className={styles.sidebarDiv}>
            <li className={styles.listItem}>
              <Link href="/chef/feedback" id={styles.link}>
          ...
          <div className={styles.sidebarDiv}>
            <li className={styles.listItem}>
              <Link href="/chef/bio" id={styles.link}>
